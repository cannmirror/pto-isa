...
python3 tests/script/build_st.py -r npu -v a5 -t tmov_l0c2ub -g TMOVTest.case_nz2nd_1
python3 tests/script/build_st.py -r npu -v a5 -t tmov_l0c2ub -g TMOVTest.case_nz2nz_vector_quant_pre_1
...
python3 tests/script/build_st.py -r npu -v a5 -t ttrans -g TTRANSTest.case1
...
python3 tests/script/build_st.py -r npu -v a5 -t tadd -g TADDTest.case_float_64x64_64x64_64x64
python3 tests/script/build_st.py -r npu -v a5 -t tpartadd -g TPARTADDTest.case_float_64x64_64x64_64x64
python3 tests/script/build_st.py -r npu -v a5 -t tsub -g TSUBTest.case_float_64x64_64x64_64x64
