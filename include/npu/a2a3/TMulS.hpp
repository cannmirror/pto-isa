...
namespace pto
{
    ...
    __tf__ __PTO_INSTR__ void TMulS(typename TileData::TileDType __out__ dst,
    ...
    __PTO_INSTR__ void TMULS_IMPL(TileData &dst, TileData &src0, typename TileData::DType scalar)
    {
