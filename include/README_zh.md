...
| [`TANDS`](../docs/isa/TANDS.md) | 是 | 是 | 是 | 是 |
...
| [`TMATMUL_MX`](../docs/isa/TMATMUL_MX.md) | 是 | TODO | TODO | 是 |
| [`TMAX`](../docs/isa/TMAX.md) | 是 | 是 | 是 | 是 |
| [`TMAXS`](../docs/isa/TMAXS.md) | 是 | 是 | 是 | 是 |
| [`TMIN`](../docs/isa/TMIN.md) | 是 | 是 | 是 | 是 |
...
| [`TNEG`](../docs/isa/TNEG.md) | 是 | 是 | 是 | 是 |
| [`TNOT`](../docs/isa/TNOT.md) | 是 | 是 | 是 | 是 |
| [`TOR`](../docs/isa/TOR.md) | 是 | 是 | 是 | 是 |
| [`TORS`](../docs/isa/TORS.md) | 是 | 是 | 是 | 是 |
...
| [`TPRINT`]() | TODO | 是 | 是 | 是 |
| [`TRECIP`](../docs/isa/TRECIP.md) | 是 | 是 | 是 | 是 |
...
| [`TROWEXPANDSUB`](../docs/isa/TROWEXPANDSUB.md) | 是 | 是 | 是 | 是 |
| [`TROWMAX`](../docs/isa/TROWMAX.md) | 是 | 是 | 是 | 是 |
| [`TROWMIN`](../docs/isa/TROWMIN.md) | 是 | 是 | 是 | 是 |
| [`TROWSUM`](../docs/isa/TROWSUM.md) | 是 | 是 | 是 | 是 |
| [`TRSQRT`](../docs/isa/TRSQRT.md) | 是 | 是 | 是 | 是 |
| [`TSCATTER`](../docs/isa/TSCATTER.md) | 是 | 是 | 是 | 是 |
| [`TSEL`](../docs/isa/TSEL.md) | 是 | 是 | 是 | 是 |
| [`TSELS`](../docs/isa/TSELS.md) | 是 | 是 | 是 | 是 |
| [`TSHL`](../docs/isa/TSHL.md) | 是 | 是 | 是 | 是 |
| [`TSHLS`](../docs/isa/TSHLS.md) | 是 | 是 | 是 | 是 |
| [`TSHR`](../docs/isa/TSHR.md) | 是 | 是 | 是 | 是 |
| [`TSHRS`](../docs/isa/TSHRS.md) | 是 | 是 | 是 | 是 |
