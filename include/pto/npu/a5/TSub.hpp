...
__tf__ PTO_INTERNAL OP_NAME(TSUB) OP_TYPE(element_wise) void TSub(typename TileData::TileDType __out__ dst,
    ...
    if constexpr (dstRowStride == src0RowStride && dstRowStride == src1RowStride) {
        BinaryInstr<SubOp<T>, TileData, elementsPerRepeat, blockSizeElem, dstRowStride>(
