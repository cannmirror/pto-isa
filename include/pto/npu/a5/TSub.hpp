...
namespace pto {
    ...
    __tf__ PTO_INTERNAL
    void TSub(typename TileData::TileDType __out__ dst, typename TileData::TileDType __in__ src0, 
              typename TileData::TileDType __in__ src1, unsigned kValidRows, unsigned kValidCols,
    ...
    PTO_INTERNAL void TSUB_IMPL(TileDataDst &dst, TileDataSrc0 &src0, TileDataSrc1 &src1)
    {
        static_assert(std::is_same_v<TileDataDst, TileDataSrc0> && std::is_same_v<TileDataDst, TileDataSrc1>,
                      "TSUB: Input tileshape must be consistent with the out tileshape.");
