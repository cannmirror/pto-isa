...
namespace pto {
    ...
    __tf__ AICORE void TRowExpandSub(typename TileData::TileDType __out__ dst, 
        ...
        RowExpandBinaryInstr<RowExpandSubOp<T>, TileData, TileDataSrc, elementsPerRepeat, blockSizeElem, rowStride>(
                                dstPtr, src0Ptr, src1Ptr, validRow, validCol);
    }

    template <typename TileData, typename TileDataSrc>
    PTO_INTERNAL void TROWEXPANDSUB_IMPL(TileData &dst, TileData &src0, TileDataSrc &src1) {
        ...
        static_assert(TileData::isRowMajor, "TROWEXPANDSUB: not supported Layout type");
        ...
        TRowExpandSub<TileData, TileDataSrc, elementsPerRepeat, blockSizeElem, rowStride>(dst.data(), src0.data(), src1.data(), validRow, validCol);
    }
}
#endif