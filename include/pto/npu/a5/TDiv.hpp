...
__tf__ PTO_INTERNAL OP_NAME(TDIV) OP_TYPE(element_wise) void TDiv(typename TileData::TileDType __out__ dst,
    ...
    if constexpr (dstRowStride == src0RowStride && dstRowStride == src1RowStride) {
        BinaryInstr<DivOp<T>, TileData, elementsPerRepeat, blockSizeElem, dstRowStride>(
