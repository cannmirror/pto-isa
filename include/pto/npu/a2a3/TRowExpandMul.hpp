...
__tf__
PTO_INTERNAL
void TRowExpandMul(typename TileDataDst::TileDType __out__ dst, typename TileDataDst::TileDType __in__ src0,
...
PTO_INTERNAL
void TROWEXPANDMUL_IMPL(TileDataDst &dst, TileDataDst &src0, TileDataSrc1 &src1) {
    static_assert(std::is_same_v<typename TileDataDst::DType, typename TileDataSrc1::DType>,
                  "TROWEXPANDMUL: src and dst data type is different!");
    ...
    static_assert(TileDataDst::isRowMajor && !TileDataSrc1::isRowMajor && TileDataSrc1::Cols == 1,
                  "TROWEXPANDMUL: Invalid tile shape.");
