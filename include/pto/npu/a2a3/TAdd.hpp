...
__tf__ PTO_INTERNAL void TAdd(typename TileDataDst::TileDType __out__ dstData,
...
PTO_INTERNAL void TADD_IMPL(TileDataDst &dst, TileDataSrc0 &src0, TileDataSrc1 &src1) {
    ...
    if ((validRow == src0.GetValidRow() && validCol == src0.GetValidCol()) &&
        ...
        TAdd<T, TileDataDst, TileDataSrc0, TileDataSrc1>(dst.data(), src0.data(), src1.data(), validRow, validCol);
    } else {
