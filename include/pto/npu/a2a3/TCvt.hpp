            ...
            switch (static_cast<RoundMode>(mode)) {
                ...
                default:
                    ...
                    break;
                            ...
                            std::is_same<typename TileDataS::DType, half>::value) {  // half to int4b
            switch (static_cast<RoundMode>(mode)) {
                case RoundMode::CAST_RINT:
            ...
            switch (static_cast<RoundMode>(mode)) {
                ...
                default:
                    ...
                    break;
                           ...
                           std::is_same<typename TileDataS::DType, int4b_t>::value) {  // int4b to half
            vconv_s42f16(dst, src, repeatNum, dstBlockStride, srcBlockStride, dstRepeatStride, srcRepeatStride);
        } */
        else if constexpr (std::is_same<typename TileDataD::DType, half>::value &&
