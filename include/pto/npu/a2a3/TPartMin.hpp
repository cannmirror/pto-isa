...
__tf__
PTO_INTERNAL
void TPartMin(typename TileDataDst::TileDType __out__ dst,
    ...
    unsigned src0ValidCol, unsigned src1ValidRow, unsigned src1ValidCol, unsigned dstValidRow, unsigned dstValidCol)
{
    ...
    PTO_ASSERT(condSrc0EqDst || condSrc1EqDst,
        "TPARTMIN: At most one entry in the rows and cols of src0 and src1 is smaller than dst.");
    ...
    if (condSrc0EqDst) {
        TPartInstr<PartMinOp<T>, T, dstCol, src0Col, dstRow, elementsPerRepeat, blockSizeElem, dstRowStride, src0RowStride,
             src1RowStride>(dstPtr, src0Ptr, src1Ptr, src0ValidRow, src0ValidCol, src1ValidRow, src1ValidCol,
             dstValidRow, dstValidCol);
    } else {
        TPartInstr<PartMinOp<T>, T, dstCol, src1Col, dstRow, elementsPerRepeat, blockSizeElem, dstRowStride, src1RowStride,
...
PTO_INTERNAL
void TPARTMIN_IMPL(TileDataDst &dst, TileDataSrc0 &src0, TileDataSrc1 &src1)
{
    ...
    static_assert(TileDataDst::isRowMajor && TileDataSrc0::isRowMajor && TileDataSrc1::isRowMajor,
                  "TPARTMIN: not supported BLayout type.");
    ...
    PTO_ASSERT(dstValidRow != static_cast<unsigned>(0) && dstValidCol != static_cast<unsigned>(0),
        "TPARTMIN: invalid dst valid shape.");
    constexpr unsigned dstRowStride = TileDataDst::RowStride;
    constexpr unsigned src0RowStride = TileDataSrc0::RowStride;
    constexpr unsigned src1RowStride = TileDataSrc1::RowStride;

    TPartMin<TileDataDst, TileDataSrc0, TileDataSrc1, elementsPerRepeat, blockSizeElem, dstRowStride, src0RowStride,
