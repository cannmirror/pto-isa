    ...
    unsigned src0ValidCol, unsigned src1ValidRow, unsigned src1ValidCol, unsigned dstValidRow, unsigned dstValidCol)
{
    ...
    PTO_ASSERT(condSrc0EqDst || condSrc1EqDst,
        "FIX: TPARTADD At most one entry in the rows and cols of src0 and src1 is smaller than dst.");
    ...
    if (condSrc0EqDst) {
        TPartInstr<PartAddOp<T>, T, dstCol, src0Col, dstRow, elementsPerRepeat, blockSizeElem, dstRowStride, src0RowStride,
        ...
        TPartInstr<PartAddOp<T>, T, dstCol, src1Col, dstRow, elementsPerRepeat, blockSizeElem, dstRowStride, src1RowStride,
