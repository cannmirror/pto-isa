...
namespace pto {
    ...
    PTO_INTERNAL void TCOLEXPANDEXPDIF_IMPL(TileData &dst, TileData &src0, TileDataSrc &src1) {
        ...
        ColExpandBinaryInstr<ColExpandExpdifOp<T>, TileData, TileDataSrc, elementsPerRepeat, blockSizeElem, rowStride>(dst.data(), src0.data(), src1.data(), validRow, validCol);
    }
} // namespace pto
#endif