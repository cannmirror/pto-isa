...
namespace pto
{
  ...
  __tf__ __PTO_INSTR__ void TRowMin(typename TileDataOut::TileDType __out__ dstData,
  ...
  __PTO_INSTR__ void TROWMIN_IMPL(TileDataOut &dst, TileDataIn &src, TileDataTmp &tmp) {
