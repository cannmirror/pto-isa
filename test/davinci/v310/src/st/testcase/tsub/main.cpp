...
TEST_F(TSUBTest, case_int32_32x32_32x32_32x32) {
    test_tsub<int32_t, 32, 32, 32, 32>();
}
TEST_F(TSUBTest, case_int16_128x32_128x32_128x32) {
    test_tsub<int16_t, 128, 32, 128, 32>();
}
