...
__global__ __aicore__ void runTSel( __gm__ T __out__ *out, __gm__ uint8_t __in__ *mask, __gm__ T __in__ *src0, __gm__ T __in__ *src1) {
    ...
    using MaskTile = Tile<Location::Vec, uint8_t, maskRow, maskCol, BLayout::RowMajor, -1, -1>;
...
template void LaunchTSel<int32_t, 2, 128, 2, 128>(int32_t *out, uint8_t *mask, int32_t *src0, int32_t *src1, void *stream);
template void LaunchTSel<int16_t, 2, 128, 2, 128>(int16_t *out, uint8_t *mask, int16_t *src0, int16_t *src1, void *stream);
template void LaunchTSel<float, 2, 8, 2, 8>(float *out, uint8_t *mask, float *src0, float *src1, void *stream);
template void LaunchTSel<aclFloat16, 2, 16, 2, 8>(aclFloat16 *out, uint8_t *mask, aclFloat16 *src0, aclFloat16 *src1, void *stream);
