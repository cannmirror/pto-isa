...
void runTFILLPAD( T *out,  T *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    ...
    auto srcGlobal = getGloablTensor<T, shape0, shape1, shape2, shape3, shape4, kGTRows, shape4, BLayout::RowMajor, dyn_>(src, gShape0, gShape1, gShape2, shape3, shape4);
    // int dstOffset = (block_idx) * (shape3/block_num) * kTCols_;
    auto dstGlobal = getGloablTensor<T, shape0, shape1, shape2, shape3, kTCols_, kGTRows, kTCols_, BLayout::RowMajor, 0>(out, gShape0, gShape1, gShape2, shape3, kTCols_); //dst TStore GlobalTensor just use static
...
{
    runTFILLPAD<float, 1, 1, 1, 128, 127, 128, 128, 1, PadValue::Max, PadValue::Max>(( float*)out, ( float*)src, gShape0, gShape1, gShape2, gRows, gCols);
}

void launchTFILLPAD_2( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<float, 1, 1, 1, 128, 127, 128, 160, 1, PadValue::Max, PadValue::Max>(( float*)out, ( float*)src, gShape0, gShape1, gShape2, gRows, gCols);
} 

void launchTFILLPAD_3( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<float, 1, 1, 1, 128, 127, 128, 160, 1, PadValue::Min, PadValue::Max>(( float*)out, ( float*)src, gShape0, gShape1, gShape2, gRows, gCols);
} 

void launchTFILLPAD_4( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<float, 1, 1, 1, 260, 7, 260, 16, 1, PadValue::Min, PadValue::Max>(( float*)out, ( float*)src, gShape0, gShape1, gShape2, gRows, gCols);
} 

void launchTFILLPAD_5( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<float, 1, 1, 1, 260, 7, 260, 16, 1, PadValue::Min, PadValue::Max, true>(( float*)out, ( float*)src, gShape0, gShape1, gShape2, gRows, gCols);
}

void launchTFILLPAD_6( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<uint16_t, 1, 1, 1, 260, 7, 260, 32, 1, PadValue::Min, PadValue::Max>(( uint16_t*)out, ( uint16_t*)src, gShape0, gShape1, gShape2, gRows, gCols);
}

void launchTFILLPAD_7( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<uint8_t, 1, 1, 1, 260, 7, 260, 64, 1, PadValue::Min, PadValue::Max>(( uint8_t*)out, ( uint8_t*)src, gShape0, gShape1, gShape2, gRows, gCols);
}

void launchTFILLPAD_8( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<uint16_t, 1, 1, 1, 259, 7, 260, 32, 1, PadValue::Min, PadValue::Max, false, true>(( uint16_t*)out, ( uint16_t*)src, gShape0, gShape1, gShape2, gRows, gCols);
}

void launchTFILLPAD_9( uint8_t *out,  uint8_t *src, int gShape0, int gShape1, int gShape2, int gRows, int gCols)
{
    runTFILLPAD<int8_t, 1, 1, 1, 259, 7, 260, 64, 1, PadValue::Min, PadValue::Max, false, true>(( int8_t*)out, ( int8_t*)src, gShape0, gShape1, gShape2, gRows, gCols);
}
