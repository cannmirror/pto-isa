...
bool TPartAddTest()
{
    ...
    LaunchTPartAdd<T, kGRowsD_, kGColsD_, kGRowsS0_, kGColsS0_, kGRowsS1_, kGColsS1_, kTRowsD_, kTColsD_, kTRowsS0_,
...
TEST_F(TPARTADDTest, test0) {
    bool res = TPartAddTest<int16_t, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, test1) {
    bool res = TPartAddTest<aclFloat16, 22, 32, 22, 32, 16, 32, 22, 32, 22, 32, 16, 32, 22, 32, 22, 32, 16, 32>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, test2) {
    bool res = TPartAddTest<float, 22, 40, 22, 40, 22, 32, 22, 40, 22, 40, 22, 32, 22, 40, 22, 40, 22, 32>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, test3) {
    bool res = TPartAddTest<int32_t, 22, 40, 22, 40, 8, 40, 22, 40, 22, 40, 8, 40, 22, 40, 22, 40, 8, 40>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, test4) {
    bool res = TPartAddTest<float, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, testEmpty0) {
    bool res = TPartAddTest<int16_t, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0, 16, 32>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, testEmpty1) {
    bool res = TPartAddTest<aclFloat16, 16, 32, 16, 32, 16, 32, 16, 32, 8, 32, 16, 32, 16, 32, 0, 32, 16, 32>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, testEmpty2) {
    bool res = TPartAddTest<float, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0>();
    EXPECT_TRUE(res);
}
TEST_F(TPARTADDTest, testEmpty3) {
    bool res = TPartAddTest<int32_t, 16, 32, 16, 32, 16, 32, 16, 32, 16, 32, 8, 32, 16, 32, 16, 32, 0, 32>();
    EXPECT_TRUE(res);
}
