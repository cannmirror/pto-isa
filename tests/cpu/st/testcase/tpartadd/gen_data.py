    ...
    for i in range(param.dst_validrow):
        for j in range(param.dst_validcol):
            ...
            if in_src0 and in_src1:
                output_arr[i, j] = input0_arr[i, j] + input1_arr[i, j]
...
if __name__ == "__main__":
    case_params_list = [
        TestParams('TPARTADDTest.test0', np.int16, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32),
        TestParams('TPARTADDTest.test1', np.float16, 22, 32, 22, 32, 16, 32, 22, 32, 22, 32, 16, 32),
        TestParams('TPARTADDTest.test2', np.float32, 22, 40, 22, 40, 22, 32, 22, 40, 22, 40, 22, 32),
        TestParams('TPARTADDTest.test3', np.int32, 22, 40, 22, 40, 8, 40, 22, 40, 22, 40, 8, 40),
        TestParams('TPARTADDTest.test4', np.float32, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128),
        TestParams('TPARTADDTest.testEmpty0', np.int16, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0, 16, 32),
        TestParams('TPARTADDTest.testEmpty1', np.float16, 16, 32, 16, 32, 16, 32, 16, 32, 0, 32, 16, 32),
        TestParams('TPARTADDTest.testEmpty2', np.float32, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0),
        TestParams('TPARTADDTest.testEmpty3', np.int32, 16, 32, 16, 32, 16, 32, 16, 32, 16, 32, 0, 32),
    ]
