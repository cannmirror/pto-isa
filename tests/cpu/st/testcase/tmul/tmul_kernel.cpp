...
__aicore__ void runTMul( __gm__ T __out__ *out, __gm__ T __in__ *src0,  __gm__ T __in__ *src1) {
...
void LaunchTMul(T *out, T *src0, T *src1, void *stream)
{
    if constexpr ( std::is_same_v<T, aclFloat16> )
        runTMul<half, kGRows_, kGCols_, kTRows_, kTCols_>((half*)(out),
                                                                                  (half*)(src0),
                                                                                  (half*)(src1));
    else 
...
template void LaunchTMul<aclFloat16, 16, 256, 16, 256>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
