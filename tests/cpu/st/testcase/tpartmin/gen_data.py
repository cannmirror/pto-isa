...
def gen_golden_data(param):
    ...
    for i in range(param.dst_validrow):
        for j in range(param.dst_validcol):
            in_src0 = i < src0_validrow and j < src0_validcol
            ...
            if in_src0 and in_src1:
                output_arr[i, j] = min(input0_arr[i, j], input1_arr[i, j])
            elif out_src0 and in_src1:
                output_arr[i, j] = input1_arr[i, j]
            elif in_src0 and out_src1:
...
if __name__ == "__main__":
    case_params_list = [
        TestParams('TPARTMINTest.test0', np.int16, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32),
        TestParams('TPARTMINTest.test1', np.float16, 22, 32, 22, 32, 16, 32, 22, 32, 22, 32, 16, 32),
        TestParams('TPARTMINTest.test2', np.float32, 22, 40, 22, 40, 22, 32, 22, 40, 22, 40, 22, 32),
        TestParams('TPARTMINTest.test3', np.int32, 22, 40, 22, 40, 8, 40, 22, 40, 22, 40, 8, 40),
        TestParams('TPARTMINTest.test4', np.float32, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128),
        TestParams('TPARTMINTest.testEmpty0', np.int16, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0, 16, 32),
        TestParams('TPARTMINTest.testEmpty1', np.float16, 16, 32, 16, 32, 16, 32, 16, 32, 0, 32, 16, 32),
        TestParams('TPARTMINTest.testEmpty2', np.float32, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0),
        TestParams('TPARTMINTest.testEmpty3', np.int32, 16, 32, 16, 32, 16, 32, 16, 32, 16, 32, 0, 32),
    ]
