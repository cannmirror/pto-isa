...
void LaunchTPartMin(T *out, T *src0, T *src1, aclrtStream stream)
{
    if constexpr (std::is_same_v<T, aclFloat16> ) {
        runTPartMin<half, kGRowsD_, kGColsD_, kGRowsS0_, kGColsS0_, kGRowsS1_, kGColsS1_, kTRowsD_, kTColsD_, kTRowsS0_,
...
template void LaunchTPartMin<int16_t, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32>
    (int16_t *out, int16_t *src0, int16_t *src1, aclrtStream stream);
template void LaunchTPartMin<aclFloat16, 22, 32, 22, 32, 16, 32, 22, 32, 22, 32, 16, 32, 22, 32, 22, 32, 16, 32>
    (aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, aclrtStream stream);
template void LaunchTPartMin<float, 22, 40, 22, 40, 22, 32, 22, 40, 22, 40, 22, 32, 22, 40, 22, 40, 22, 32>
    (float *out, float *src0, float *src1, aclrtStream stream);
template void LaunchTPartMin<int32_t, 22, 40, 22, 40, 8, 40, 22, 40, 22, 40, 8, 40, 22, 40, 22, 40, 8, 40>
    (int32_t *out, int32_t *src0, int32_t *src1, aclrtStream stream);
template void LaunchTPartMin<float, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128, 64, 128>
    (float *out, float *src0, float *src1, aclrtStream stream);
template void LaunchTPartMin<int16_t, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0, 16, 32>
    (int16_t *out, int16_t *src0, int16_t *src1, aclrtStream stream);
template void LaunchTPartMin<aclFloat16, 16, 32, 16, 32, 16, 32, 16, 32, 8, 32, 16, 32, 16, 32, 0, 32, 16, 32>
    (aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, aclrtStream stream);
template void LaunchTPartMin<float, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 16, 16, 32, 16, 32, 16, 0>
    (float *out, float *src0, float *src1, aclrtStream stream);
template void LaunchTPartMin<int32_t, 16, 32, 16, 32, 16, 32, 16, 32, 16, 32, 8, 32, 16, 32, 16, 32, 0, 32>
    (int32_t *out, int32_t *src0, int32_t *src1, aclrtStream stream);
