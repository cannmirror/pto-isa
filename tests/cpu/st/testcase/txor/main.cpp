...
TEST_F(TXORTest, case_int16_64x64_64x64_64x64) {
    test_txor<int16_t, NUM_64, NUM_64, NUM_64, NUM_64>();
}
TEST_F(TXORTest, case_int32_16x256_16x256_16x256) {
    test_txor<int32_t, NUM_16, NUM_256, NUM_16, NUM_256>();
}
