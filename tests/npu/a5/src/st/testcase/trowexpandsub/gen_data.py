...
def generate_case_name(param):
    ...
    return f"TRowExpandSubTest.case_{dtype_str}_{param.dst_row}_{param.dst_col}_{param.src1_row}_{param.src1_col}"
...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TrowexpandParams(np.float16, 32, 64, 32, 64, 32, 1),
    ]
