...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TMovParams(np.float16, np.float16, np.float32, 128, 64, 128, 'NZ', 1024),
        TMovParams(np.float16, np.float16, np.float32, 16, 16, 8, 'NZ', 512, False, False, True),
        TMovParams(np.float16, np.float16, bfloat16, 32, 128, 64, 'NZ'),

        TMovParams(np.float16, np.float16, np.float16, 65, 40, 80, 'ND', 512, False, False, True),
        ...
        TMovParams(np.float16, np.float16, np.float16, 80, 40, 66, 'DN'),
        TMovParams(np.float16, np.float16, np.float32, 88, 48, 95, 'DN'),
        TMovParams(np.float16, np.float16, bfloat16, 48, 80, 60, 'DN', 512, False, False, True),
        TMovParams(np.float16, np.float16, np.float32, 8, 7, 6, 'DN'),

        TMovParams(np.float16, np.float16, np.float16, 128, 64, 64, 'NZ', 512, True, False, False, np.uint64),
        TMovParams(np.float16, np.float16, np.int8, 128, 64, 64, 'NZ', 512, True, False, False, np.uint64),
        TMovParams(np.int8, np.int8, np.float16, 128, 128, 64, 'NZ', 512, True, False, True, np.uint64),
        TMovParams(np.int8, np.int8, np.int8, 64, 128, 128, 'NZ', 512, True, False, True, np.uint64),

        TMovParams(np.float16, np.float16, np.float16, 111, 47, 96, 'ND', 512, True, False, True, np.uint64),
        TMovParams(np.float16, np.float16, np.int8, 60, 128, 64, 'ND', 512, True, False, True, np.uint64),
        TMovParams(np.int8, np.int8, np.float16, 30, 48, 64, 'ND', 512, True, False, False, np.uint64),
        TMovParams(np.int8, np.int8, np.int8, 60, 48, 32, 'ND', 512, True, False, False, np.uint64),

        TMovParams(np.float16, np.float16, np.float16, 80, 80, 80, 'DN', 512, True, False, False, np.uint64),
        TMovParams(np.float16, np.float16, np.int8, 96, 128, 60, 'DN', 512, True, False, False, np.uint64),
        TMovParams(np.int8, np.int8, np.float16, 64, 48, 60, 'DN', 512, True, False, True, np.uint64),
        TMovParams(np.int8, np.int8, np.int8, 64, 64, 90, 'DN', 512, True, False, True, np.uint64),

        TMovParams(np.float16, np.float16, np.float16, 112, 48, 96, 'NZ', 512, False, True, True, None, 4),
        TMovParams(np.float16, np.float16, np.int8, 112, 96, 64, 'NZ', 512, False, True, True, None, 3),
        TMovParams(np.int8, np.int8, np.float16, 32, 128, 64, 'NZ', 512, False, True, False, None, 5),
        TMovParams(np.int8, np.int8, np.int8, 64, 32, 64, 'NZ', 512, False, True, False, None, 2),

        TMovParams(np.float16, np.float16, np.float16, 112, 48, 96, 'ND', 512, False, True, False, None, 4),
        TMovParams(np.float16, np.float16, np.int8, 60, 128, 64, 'ND', 512, False, True, False, None, 3),
        TMovParams(np.int8, np.int8, np.float16, 30, 48, 64, 'ND', 512, False, True, True, None, 5),
        TMovParams(np.int8, np.int8, np.int8, 60, 48, 32, 'ND', 512, False, True, True, None, 2),

        TMovParams(np.float16, np.float16, np.float16, 80, 40, 66, 'DN', 512, False, True, True, None, 4),
        TMovParams(np.float16, np.float16, np.int8, 96, 128, 60, 'DN', 512, False, True, True, None, 3),
        TMovParams(np.int8, np.int8, np.float16, 128, 128, 64, 'DN', 512, False, True, False, None, 5),
        TMovParams(np.int8, np.int8, np.int8, 64, 64, 90, 'DN', 512, False, True, False, None, 2),
    ]
