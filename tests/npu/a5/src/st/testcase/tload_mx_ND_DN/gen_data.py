...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TmatmulParams("TLOADMXTest.1_1_1_16_64_uint8_AND2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1, 16,
                      64, 1, 1, 1, 16, 64, 16, 64, DataFormat['AND2ZZ'].value),
        TmatmulParams("TLOADMXTest.1_1_1_32_128_uint8_AND2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1, 32,
                      128, 1, 1, 1, 32, 128, 32, 128, DataFormat['AND2ZZ'].value),                      
        ...
        # ADN2ZZ
        TmatmulParams("TLOADMXTest.1_1_1_16_4_uint8_ADN2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1, 16,
                      4, 1, 1, 1, 16, 4, 16, 4, DataFormat['ADN2ZZ'].value),
        ...
        TmatmulParams("TLOADMXTest.1_1_1_128_128_uint8_ADN2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1, 128,
                      128, 1, 1, 1, 128, 128, 128, 128, DataFormat['ADN2ZZ'].value),
        ...
        TmatmulParams("TLOADMXTest.1_1_1_32_128_uint8_BND2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1, 32,
                      128, 1, 1, 1, 32, 128, 32, 128, DataFormat['BND2NN'].value),                      
        ...
        TmatmulParams("TLOADMXTest.1_1_1_32_128_uint8_BDN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1, 32,
                      128, 1, 1, 1, 32, 128, 32, 128, DataFormat['BDN2NN'].value),                      
        TmatmulParams("TLOADMXTest.1_1_1_128_128_uint8_BDN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1, 128,
                      128, 1, 1, 1, 128, 128, 128, 128, DataFormat['BDN2NN'].value),
