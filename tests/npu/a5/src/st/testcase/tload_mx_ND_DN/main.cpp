...
{
    TLOADMXFUNC<uint8_t, 0, 1, 1, 1, 16, 64, 1, 1, 1, 16, 64, 16, 64>();
}
TEST_F(TLOADMXTest, 1_1_1_32_128_uint8_AND2ZZ)
{
    TLOADMXFUNC<uint8_t, 0, 1, 1, 1, 32, 128, 1, 1, 1, 32, 128, 32, 128>();
}
...
{
    TLOADMXFUNC<uint8_t, 1, 1, 1, 1, 16, 4, 1, 1, 1, 16, 4, 16, 4>();
}
...
{
    TLOADMXFUNC<uint8_t, 1, 1, 1, 1, 128, 128, 1, 1, 1, 128, 128, 128, 128>();
}
...
{
    TLOADMXFUNC<uint8_t, 2, 1, 1, 1, 32, 128, 1, 1, 1, 32, 128, 32, 128>();
}
...
{
    TLOADMXFUNC<uint8_t, 3, 1, 1, 1, 32, 128, 1, 1, 1, 32, 128, 32, 128>();
}
TEST_F(TLOADMXTest, 1_1_1_128_128_uint8_BDN2NN)
{
    TLOADMXFUNC<uint8_t, 3, 1, 1, 1, 128, 128, 1, 1, 1, 128, 128, 128, 128>();
}
