...
void test_tpartmin() {
    ...
    if constexpr (dstTR == 0 || dstTC == 0 || src0TR == 0 || src0TC == 0 || src1TR == 0 || src1TC == 0) {
        LaunchTPartMin<T, dstVR, dstVC, src0VR, src0VC, src1VR, src1VC>(dstDevice, src0Device, src1Device, stream);
    } else {
        LaunchTPartMin<T, dstVR, dstVC, src0VR, src0VC, src1VR, src1VC,
...
TEST_F(TPARTMINTest, case_fp32_64x64_64x64_64x64) {
    test_tpartmin<float, 64, 64, 64, 64, 64, 64, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_fp32_2x24_2x24_2x8) {
    test_tpartmin<float, 2, 24, 2, 24, 2, 8, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_fp32_128x64_128x64_96x64) {
    test_tpartmin<float, 128, 64, 128, 64, 96, 64, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_fp32_95x95_95x95_95x95) {
    test_tpartmin<float, 95, 95, 95, 95, 95, 95, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_fp32_122x123_104x123_122x110) {
    test_tpartmin<float, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_s16_122x123_104x123_122x110) {
    test_tpartmin<int16_t, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_s32_122x123_104x123_122x110) {
    test_tpartmin<int32_t, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_u16_122x123_104x123_122x110) {
    test_tpartmin<uint16_t, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_u32_122x123_104x123_122x110) {
    test_tpartmin<uint32_t, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_u8_122x123_104x123_122x110) {
    test_tpartmin<uint8_t, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_s8_122x123_104x123_122x110) {
    test_tpartmin<int8_t, 122, 123, 104, 123, 122, 110, 0, 0, 0, 0, 0, 0>();
}
TEST_F(TPARTMINTest, case_fp16_5x33_5x33_5x33) {
    test_tpartmin<aclFloat16, 5, 33, 5, 33, 5, 33, 6, 1520, 6, 1520, 6, 464>();
}
} // namespace TPartMinTest