...
void LaunchTMul(T *out, T *src0, T *src1, void *stream)
{
    if constexpr (sameTile) {
        ...
        runTMul<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH,
...
{
    if constexpr (sameTile) {
        runTMul<half, dstTileH, dstTileW, vRows, vCols><<<1, nullptr, stream>>>
            ((half*)(out), (half*)(src0), (half*)(src1));
    } else {
        runTMul<half, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH,
