...
def gen_golden_data(case_name, param):
    ...
    # fixpipe
    if param.is_v_quant:
        golden = get_vector_quant(golden, m, n, dst_type, param.quant_type)
    ...
    if dst_format == 'NZ':
        golden = get_golden_nd_to_nz(golden, m, n, dst_type, s_fractal_size)
    elif dst_format == 'DN':
...
class TMovParams:
    def __init__(self, atype, btype, dst_type, m, k, n, dst_format='ND', s_fractal_size=512, is_v_quant=False,
...
if __name__ == "__main__":
    ...
    case_params_list = [
        TMovParams(np.float16, np.float16, np.float32, 60, 127, 120, 'ND', 512, False, False, True),
        TMovParams(np.float16, np.float16, np.float16, 110, 100, 80, 'ND', 512, False, False, True),
        ...
        TMovParams(np.float16, np.float16, np.float16, 96, 80, 112, 'NZ'),
        TMovParams(np.float16, np.float16, np.float32, 80, 112, 96, 'NZ', 1024),
        TMovParams(np.float32, np.float32, np.float32, 16, 16, 8, 'NZ', 512, False, False, True),
        TMovParams(np.float16, np.float16, bfloat16, 48, 112, 48, 'NZ', 512, False, False, True),

        TMovParams(np.float32, np.float32, np.float32, 48, 80, 128, 'NZ', 1024),  # nz2nz.f32@f32->f32.split n
        TMovParams(np.float16, np.float16, np.float32, 80, 16, 96, 'NZ', 1024),  # nz2nz.f16@f16->f32.split n
        TMovParams(np.float16, np.float16, np.float32, 112, 48, 80, 'NZ', 1024),  # nz2nz.f16@f16->f32.split m
        TMovParams(np.float32, np.float32, np.float32, 16, 112, 112, 'NZ', 1024),  # nz2nz.f32@f32->f32.split m

        TMovParams(np.float32, np.float32, np.float32, 8, 7, 6, 'DN'),
        TMovParams(np.float16, np.float16, np.float16, 112, 48, 95, 'DN'),
        TMovParams(np.float16, np.float16, bfloat16, 48, 31, 31, 'DN', 512, False, False, True),
        TMovParams(np.float16, np.float16, np.float32, 88, 48, 95, 'DN', 512, False, False, True),

        TMovParams(np.int8, np.int8, np.int8, 128, 48, 128, 'NZ', 512, True, False, False, np.uint64),
        TMovParams(np.int8, np.int8, np.float16, 64, 80, 96, 'NZ', 512, True, False, False, np.uint64),
        TMovParams(np.float32, np.float32, np.int8, 128, 32, 96, 'NZ', 512, True, False, True, np.uint64),
        TMovParams(np.float32, np.float32, np.float16, 80, 16, 112, 'NZ', 512, True, False, True, np.uint64),

        TMovParams(np.float32, np.float32, np.float16, 48, 32, 80, 'NZ', 512, False, True, True, None, 2),
        TMovParams(np.int8, np.int8, np.float16, 96, 48, 128, 'NZ', 512, False, True, True, None, 4),
        TMovParams(np.int8, np.int8, np.int8, 128, 64, 128, 'NZ', 512, False, True, False, None, 5),
        TMovParams(np.float32, np.float32, np.int8, 64, 80, 96, 'NZ', 512, False, True, False, None, 7),

        TMovParams(np.int8, np.int8, np.int8, 30, 48, 64, 'ND', 512, True, False, False, np.uint64),     
        TMovParams(np.int8, np.int8, np.float16, 60, 128, 32, 'ND', 512, True, False, False, np.uint64),    
        TMovParams(np.int8, np.int8, bfloat16, 128, 64, 96, 'ND', 512, True, False, False, np.uint64),
        TMovParams(np.float32, np.float32, np.int8, 60, 128, 64, 'ND', 512, True, False, True, np.uint64),     
        TMovParams(np.float32, np.float32, np.float16, 31, 128, 128, 'ND', 512, True, False, True, np.uint64),  

        TMovParams(np.float32, np.float32, np.float16, 128, 48, 96, 'ND', 512, False, True, True, None, 2),
        TMovParams(np.float32, np.float32, np.int8, 60, 128, 64, 'ND', 512, False, True, True, None, 5),
        TMovParams(np.int8, np.int8, np.float16, 30, 48, 64, 'ND', 512, False, True, False, None, 3),
        TMovParams(np.int8, np.int8, np.int8, 60, 128, 32, 'ND', 512, False, True, False, None, 1),

        TMovParams(np.int8, np.int8, np.int8, 96, 128, 60, 'DN', 512, True, False, False, np.uint64),
        TMovParams(np.int8, np.int8, np.float16, 32, 48, 64, 'DN', 512, True, False, False, np.uint64),
        TMovParams(np.float16, np.float16, np.int8, 32, 128, 60, 'DN', 512, True, False, True, np.uint64),
        TMovParams(np.float16, np.float16, np.float16, 64, 64, 90, 'DN', 512, True, False, True, np.uint64),

        TMovParams(np.float32, np.float32, np.float16, 80, 40, 66, 'DN', 512, False, True, True, None, 2),
        TMovParams(np.float32, np.float32, np.int8, 96, 128, 60, 'DN', 512, False, True, True, None, 5),
        TMovParams(np.int8, np.int8, np.float16, 32, 128, 64, 'DN', 512, False, True, False, None, 3),
        TMovParams(np.int8, np.int8, np.int8, 64, 64, 90, 'DN', 512, False, True, False, None, 1),
    ]
