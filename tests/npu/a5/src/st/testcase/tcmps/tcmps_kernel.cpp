...
template void LaunchTCmps<float, 128, 128, 128, 128, 5>(uint32_t *out, float *src0, float *src1, void *stream);
...
template void LaunchTCmps<int16_t, 77, 81, 32, 32, 5>(uint32_t *out, int16_t *src0, int16_t *src1, void *stream);
