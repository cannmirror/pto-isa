...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        tcmpsParams(np.float32, 128, 128, 128, 128, 64, 64, "CmpMode::LT"),
        tcmpsParams(np.int32, 64, 64, 64, 64, 32, 32, "CmpMode::EQ"),
        ...
        tcmpsParams(np.int16, 16, 32, 16, 32, 16, 32, "CmpMode::EQ"),
