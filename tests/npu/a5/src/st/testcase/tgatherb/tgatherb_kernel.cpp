...
template void LaunchTGatherB<int32_t, 2, 128, 2, 16, 2, 128>(int32_t *out, int32_t *src, uint32_t *offset, void *stream);
template void LaunchTGatherB<uint32_t, 2, 128, 2, 16, 2, 128>(uint32_t *out, uint32_t *src, uint32_t *offset, void *stream);
template void LaunchTGatherB<int16_t, 1, 32768, 1, 2048, 1, 32768>(int16_t *out, int16_t *src, uint32_t *offset, void *stream);
template void LaunchTGatherB<uint16_t, 257, 128, 257, 8, 257, 128>(uint16_t *out, uint16_t *src, uint32_t *offset, void *stream);
...
template void LaunchTGatherB<int8_t, 2, 32768, 2, 1024, 2, 32768>(int8_t *out, int8_t *src, uint32_t *offset, void *stream);
template void LaunchTGatherB<uint8_t, 2, 32768, 2, 1024, 2, 32768>(uint8_t *out, uint8_t *src, uint32_t *offset, void *stream);