...
{
    TMrgsortMulti<float, 1, 128, 1, 128, 128, 128, 64, 448, 4, false>();
}

TEST_F(TMRGSORTTest, case_multi4)
{
    TMrgsortMulti<float, 1, 128, 1, 128, 128, 64, 0, 128, 3, false>();
}
...
{
    TMrgsortTopk<float, 1, 2048, 1, 2048, 1024>();
}
...
{
    TMrgsortTopk<float, 1, 1280, 1, 1280, 512>();
}
