...
template void launchTRowExpandExpdif<float, 12, 64, 12, 1>(float *out, float *src0, float *src1, void *stream);
...
template void launchTRowExpandExpdif<aclFloat16, 14, 64, 14, 1>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
}