...
def generate_case_name(param):
    ...
    return f"TRowExpandExpdifTest.case_{dtype_str}_{param.dst_row}_{param.dst_col}_{param.src1_row}_{param.src1_col}"
...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TrowexpandParams(np.float16, 14, 64, 14, 64, 14, 1),
    ]
