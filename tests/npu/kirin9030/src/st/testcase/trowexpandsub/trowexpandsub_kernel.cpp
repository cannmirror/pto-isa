...
void launchTRowExpandSub(T *out, T*src0, T*src1, void *stream) {
    if constexpr (std::is_same_v<T, aclFloat16>) {
        runROWEXPANDSUB<half, dstRow, dstCol, src1Row, src1Col, src0eqdst><<<1, nullptr, stream>>>((half*)out, (half*)src0, (half*)src1);
    } else {
...
void launchTRowExpandSub2(T *out, T*src0, T*src1, void *stream) {
    if constexpr (std::is_same_v<T, aclFloat16>) {
        runROWEXPANDSUB2<half, dstRow, dstCol, src1Row, src1Col, src0eqdst><<<1, nullptr, stream>>>((half*)out, (half*)src0, (half*)src1);
    } else {
...
template void launchTRowExpandSub<aclFloat16, 16, 256, 16, 1, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void launchTRowExpandSub<aclFloat16, 32, 64, 32, 1, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
...
template void launchTRowExpandSub2<aclFloat16, 16, 64, 16, 16, false>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
}