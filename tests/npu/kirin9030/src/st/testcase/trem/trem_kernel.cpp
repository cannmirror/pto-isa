...
template void LaunchTRem<uint16_t, 1, 16384, 1, 16384, false>(uint16_t *out, uint16_t *src0, uint16_t *src1, void *stream);
template void LaunchTRem<uint16_t, 2048, 16, 2048, 16, false>(uint16_t *out, uint16_t *src0, uint16_t *src1, void *stream);
...
template void LaunchTRem<aclFloat16, 32, 32, 31, 31, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
