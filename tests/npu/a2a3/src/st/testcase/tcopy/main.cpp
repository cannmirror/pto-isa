...
class TCOPYTest : public testing::Test {
protected:
    void SetUp() override
    {}
...
TEST_F(TCOPYTest, case1)
{
    ...
    ReadFile(GetGoldenDir() + "/input_arr.bin", srcFileSize, srcHost, srcFileSize);

    aclrtMemcpy(srcDevice, srcFileSize, srcHost, srcFileSize, ACL_MEMCPY_HOST_TO_DEVICE);
    launchTCOPY1(dstDevice, srcDevice, stream);
