...
void launchTRowExpandAdd(T *out, T *src0, T *src1, void *stream)
{
    if constexpr ( std::is_same_v<T, aclFloat16> )
        runTRowExpandAdd<half, validRow, validCol, Row, Col, src0eqdst><<<1, nullptr, stream>>>((half*)(out),
                                                                                     (half*)(src0),
                                                                                     (half*)(src1));
    else 
...
{
    if constexpr ( std::is_same_v<T, aclFloat16> )
        runTRowExpandAdd2<half, validRow, validCol, Row, Col, src0eqdst><<<1, nullptr, stream>>>((half*)(out),
                                                                                     (half*)(src0),
                                                                                     (half*)(src1));
    else 
...
template void launchTRowExpandAdd<aclFloat16, 16, 16, 16, 16, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void launchTRowExpandAdd<aclFloat16, 16, 16, 32, 32, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
...
template void launchTRowExpandAdd2<aclFloat16, 16, 16, 16, 16, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void launchTRowExpandAdd2<aclFloat16, 16, 16, 32, 32, true>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
