...
template void LaunchTPrelu<aclFloat16, 64, 64, 64, 64>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void LaunchTPrelu<aclFloat16, 64, 64, 63, 63>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void LaunchTPrelu<aclFloat16, 1, 16384, 1, 16384>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void LaunchTPrelu<aclFloat16, 1024, 16, 1024, 16>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
