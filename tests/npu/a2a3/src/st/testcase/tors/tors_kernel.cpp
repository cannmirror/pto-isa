...
template void LaunchTOrS<int16_t, 64, 64, 64, 64, 64, 64>
    (int16_t *out, int16_t *src, int16_t scalar, void *stream);
template void LaunchTOrS<int16_t, 32, 128, 32, 128, 32, 128>
    (int16_t *out, int16_t *src, int16_t scalar, void *stream);
template void LaunchTOrS<int16_t, 32, 112, 32, 128, 32, 111>
    (int16_t *out, int16_t *src, int16_t scalar, void *stream);
template void LaunchTOrS<uint16_t, 64, 64, 64, 64, 64, 64>
