...
class TDIVPLUSTest : public testing::Test {
protected:
    void SetUp() override {}
...
void test_tdiv() {
    ...
    LaunchTDiv<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols>(
...
TEST_F(TDIVPLUSTest, case_half_16x64_16x128_16x128_16x64) {
    test_tdiv<aclFloat16, 16, 64, 16, 128, 16, 128, 16, 64>();
}

TEST_F(TDIVPLUSTest, case_float_16x32_16x64_16x32_16x32) {
    test_tdiv<float, 16, 32, 16, 64, 16, 32, 16, 32>();
}

TEST_F(TDIVPLUSTest, case_half_16x64_16x128_16x128_16x63) {
    test_tdiv<aclFloat16, 16, 64, 16, 128, 16, 128, 16, 63>();
}

TEST_F(TDIVPLUSTest, case_float_16x32_16x64_16x32_16x31) {
