...
def gen_golden_data_tdivplus(case_name, param):
    dtype = param.dtype
...
def generate_case_name(param):
    ...
    return f"TDIVPLUSTest.case_{dtype_str}_{param.dst_tile_row}x{param.dst_tile_col}_{param.src0_tile_row}x{param.src0_tile_col}_{param.src1_tile_row}x{param.src1_tile_col}_{param.valid_row}x{param.valid_col}"
...
if __name__ == "__main__":
    ...
    case_params_list = [
        TDivPlusParams(np.float16, 16, 64, 16, 128, 16, 128, 16, 64),
        TDivPlusParams(np.float32, 16, 32, 16, 64, 16, 32, 16, 32),
        TDivPlusParams(np.float16, 16, 64, 16, 128, 16, 128, 16, 63),
        TDivPlusParams(np.float32, 16, 32, 16, 64, 16, 32, 16, 31),
    ]
    ...
    for param in case_params_list:
        ...
        os.chdir(case_name)
        gen_golden_data_tdivplus(case_name, param)
