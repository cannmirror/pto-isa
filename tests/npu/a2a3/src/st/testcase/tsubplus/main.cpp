...
class TSUBPLUSTest : public testing::Test {
protected:
    void SetUp() override {}
...
void test_tsub() {
    ...
    LaunchTSub<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols>(
...
TEST_F(TSUBPLUSTest, case_half_16x64_16x128_16x128_16x64) {
    test_tsub<aclFloat16, 16, 64, 16, 128, 16, 128, 16, 64>();
}

TEST_F(TSUBPLUSTest, case_float_16x32_16x64_16x32_16x32) {
    test_tsub<float, 16, 32, 16, 64, 16, 32, 16, 32>();
}

TEST_F(TSUBPLUSTest, case_int16_32x128_32x128_32x256_32x128) {
    test_tsub<int16_t, 32, 128, 32, 128, 32, 256, 32, 128>();
}

TEST_F(TSUBPLUSTest, case_int32_16x32_16x64_16x32_16x32) {
    test_tsub<int32_t, 16, 32, 16, 64, 16, 32, 16, 32>();
}

TEST_F(TSUBPLUSTest, case_half_16x64_16x128_16x128_16x63) {
    test_tsub<aclFloat16, 16, 64, 16, 128, 16, 128, 16, 63>();
}

TEST_F(TSUBPLUSTest, case_float_16x32_16x64_16x32_16x31) {
    test_tsub<float, 16, 32, 16, 64, 16, 32, 16, 31>();
}

TEST_F(TSUBPLUSTest, case_int16_32x128_32x128_32x256_32x127) {
    test_tsub<int16_t, 32, 128, 32, 128, 32, 256, 32, 127>();
}

TEST_F(TSUBPLUSTest, case_int32_16x32_16x64_16x32_16x31) {
