...
if __name__ == "__main__":
    case_params_list = [
        tdivsParams("TDIVSPLUSTest.case1", np.float32, 32, 128, 32, 64),
        tdivsParams("TDIVSPLUSTest.case2", np.float16, 63, 128, 63, 64),
        tdivsParams("TDIVSPLUSTest.case3", np.int32, 31, 256, 31, 128),
        tdivsParams("TDIVSPLUSTest.case4", np.int16, 15, 192, 15, 64 * 3),
        tdivsParams("TDIVSPLUSTest.case5", np.float32, 7, 512, 7, 64 * 7),
        tdivsParams("TDIVSPLUSTest.case6", np.float32, 256, 32, 256, 16)
    ]
