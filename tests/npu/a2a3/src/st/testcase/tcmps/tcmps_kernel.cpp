...
__global__ __aicore__ void runTCmps( __gm__ uint8_t __out__ *out, __gm__ T __in__ *src0, __gm__ T __in__ *src1) {
...
template void LaunchTCmps<aclFloat16, 32, 32, 32, 32, CmpMode::GE>(uint8_t *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
