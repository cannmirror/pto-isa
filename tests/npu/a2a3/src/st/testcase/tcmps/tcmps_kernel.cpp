...
template void LaunchTCmps<aclFloat16, 32, 32, 32, 32, 4>(uint8_t *out, aclFloat16 *src0, aclFloat16 *src1, void *stream);
template void LaunchTCmps<float, 1, 64, 1, 64, 0>(uint8_t *out, float *src0, float *src1, void *stream);
template void LaunchTCmps<float, 8, 64, 8, 64, 3>(uint8_t *out, float *src0, float *src1, void *stream);
...
template void LaunchTCmps<float, 128, 128, 128, 128, 5>(uint8_t *out, float *src0, float *src1, void *stream);
