...
class TMINPLUSTest : public testing::Test {
protected:
    void SetUp() override
    {}
...
void test_tmin() {
    ...
    LaunchTMin<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols, padValueType>(
...
TEST_F(TMINPLUSTest, case_float_64x64_PAD_VALUE_NULL) {
    test_tmin<float, 64, 64, 64, 64, 64, 64, 64, 64, PAD_VALUE_NULL>();
}
TEST_F(TMINPLUSTest, case_int32_64x64_PAD_VALUE_NULL) {
    test_tmin<int32_t, 64, 64, 64, 64, 64, 64, 64, 64, PAD_VALUE_NULL>();
}
TEST_F(TMINPLUSTest, case_half_64x64_PAD_VALUE_NULL) {
    test_tmin<aclFloat16, 64, 64, 64, 64, 64, 64, 64, 64, PAD_VALUE_NULL>();
}
TEST_F(TMINPLUSTest, case_int16_64x64_PAD_VALUE_NULL) {
    test_tmin<int16_t, 64, 64, 64, 64, 64, 64, 64, 64, PAD_VALUE_NULL>();
}

TEST_F(TMINPLUSTest, case_float_60x60_PAD_VALUE_MIN) {
    test_tmin<float, 60, 128, 64, 64, 60, 128, 60, 60, PAD_VALUE_MIN>();
}
TEST_F(TMINPLUSTest, case_int32_60x60_PAD_VALUE_MIN) {
    test_tmin<int32_t, 60, 128, 64, 64, 60, 128, 60, 60, PAD_VALUE_MIN>();
}
TEST_F(TMINPLUSTest, case_half_1x3600_PAD_VALUE_MIN) {
    test_tmin<aclFloat16, 1, 3600, 2, 4096, 1, 3600, 1, 3600, PAD_VALUE_MIN>();
}
TEST_F(TMINPLUSTest, case_int16_16x200_PAD_VALUE_MIN) {
    test_tmin<int16_t, 16, 256, 20, 512, 16, 256, 16, 200, PAD_VALUE_MIN>();
}