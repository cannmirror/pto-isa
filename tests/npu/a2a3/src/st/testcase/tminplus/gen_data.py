...
def generate_case_name(param):
    ...
    return f"TMINPLUSTest.case_{dtype_str}_{param.valid_row}x{param.valid_col}_{param.pad_value_type}"
...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        testParams(np.float32, 60, 128, 64, 64, 60, 128, 60, 60, PAD_VALUE_MIN),
        testParams(np.int32, 60, 128, 64, 64, 60, 128, 60, 60, PAD_VALUE_MIN),
        testParams(np.float16, 1, 3600, 2, 4096, 1, 3600, 1, 3600, PAD_VALUE_MIN),
        testParams(np.int16, 16, 256, 20, 512, 16, 256, 16, 200, PAD_VALUE_MIN),
    ]
