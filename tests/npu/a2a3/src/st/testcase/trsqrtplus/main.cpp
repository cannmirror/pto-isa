...
void test_trsqrt()
{
    ...
    LaunchTRsqrt<T, dstTileRow, dstTileCol, srcTileRow, srcTileCol, validRow, validCol, isInPlace>(
...
TEST_F(TRSQRTTest, case_float_64x64_64x128_64x64_inPlace_True) {
    test_trsqrt<float, 64, 64, 64, 128, 64, 64, true>();
}
TEST_F(TRSQRTTest, case_float_128x64_64x64_64x64_inPlace_False) {
    test_trsqrt<float, 128, 64, 64, 64, 64, 64, false>();
}
TEST_F(TRSQRTTest, case_half_64x64_128x128_64x64_inPlace_True) {
    test_trsqrt<aclFloat16, 64, 64, 128, 128, 64, 64, true>();
}
TEST_F(TRSQRTTest, case_half_64x256_64x64_64x64_inPlace_False) {
    test_trsqrt<aclFloat16, 64, 256, 64, 64, 64, 64, false>();
}