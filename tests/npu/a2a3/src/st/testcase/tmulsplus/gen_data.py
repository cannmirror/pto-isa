...
if __name__ == "__main__":
    case_params_list = [
        taddsParams("TMULSPLUSTest.case1", np.float32, 32, 128, 32, 64),
        taddsParams("TMULSPLUSTest.case2", np.float16, 63, 128, 63, 64),
        taddsParams("TMULSPLUSTest.case3", np.int32, 31, 256, 31, 128),
        taddsParams("TMULSPLUSTest.case4", np.int16, 15, 192, 15, 64 * 3),
        taddsParams("TMULSPLUSTest.case5", np.float32, 7, 512, 7, 64 * 7),
        taddsParams("TMULSPLUSTest.case6", np.float32, 256, 32, 256, 16)
    ]
