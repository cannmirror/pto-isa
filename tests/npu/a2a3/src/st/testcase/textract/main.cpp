...
void tmov_test(uint32_t M, uint32_t N, uint32_t K, uint32_t targetM = 0, uint32_t targetN = 0, uint32_t targetK = 0)
{
...
void textract_test(uint32_t M, uint32_t N, uint32_t K, uint16_t indexM, uint16_t indexN, uint16_t indexK,
    uint32_t targetM = 0, uint32_t targetN = 0, uint32_t targetK = 0)
{
    targetM = (targetM == 0) ? M : targetM;
    targetN = (targetN == 0) ? N : targetN;
    targetK = (targetK == 0) ? K : targetK;
