...
void test_trowexpandsub()
{
    ...
    launchTRowExpandSub<T, validRow, validCol, Row, Col>(dstDevice, src0Device, src1Device, stream);
...
{
    test_trowexpandsub<float, 16, 16, 16, 16>();
}

TEST_F(TROWEXPANDSUBTest, case2)
{
    test_trowexpandsub<float, 16, 16, 32, 32>();
}
TEST_F(TROWEXPANDSUBTest, case3)
{
    test_trowexpandsub<aclFloat16, 16, 16, 16, 16>();
}

TEST_F(TROWEXPANDSUBTest, case4)
{
    test_trowexpandsub<aclFloat16, 16, 16, 32, 32>();
}
TEST_F(TROWEXPANDSUBTest, case5)
{
    test_trowexpandsub<float, 1, 16384, 1, 16384>();
}

TEST_F(TROWEXPANDSUBTest, case6)
{
    test_trowexpandsub<float, 2048, 1, 2048, 8>();
}
