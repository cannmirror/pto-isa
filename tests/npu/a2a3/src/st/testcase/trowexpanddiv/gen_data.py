...
if __name__ == "__main__":
    ...
    case_params_list = [
        TRowExpandDiv(np.float32, 16, 16, 16, 16),
        TRowExpandDiv(np.float32, 16, 16, 32, 32),
        TRowExpandDiv(np.float16, 16, 16, 16, 16),
        TRowExpandDiv(np.float16, 16, 16, 32, 32),
        TRowExpandDiv(np.float32, 1, 16384, 1, 16384),
        TRowExpandDiv(np.float32, 2048, 1, 2048, 8),
    ]
